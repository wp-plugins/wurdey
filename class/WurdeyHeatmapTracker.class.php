...
class WurdeyHeatmapTracker
{
	...
	public function saveClickCallback()
	{
		...
		$storeData = get_option('wurdey_child_click_data');
        ...
        WurdeyHelper::update_option('wurdey_child_click_data', $storeData);
	...
	public function sendClick()
	{
		...
		$clickData = get_option('wurdey_child_click_data');
		...
		if ( is_array($request) && intval($request['body']) > 0 )
			delete_option('wurdey_child_click_data');
	}
