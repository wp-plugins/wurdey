...
class WurdeyChildBranding
{
    ...
    {
        if (WurdeyChildBranding::$instance == null)
        {
            WurdeyChildBranding::$instance = new WurdeyChildBranding();
        }
        return WurdeyChildBranding::$instance;
    }
    ...
    public function __construct()
    {
        ...
        $label = get_option("wurdey_branding_button_contact_label");
        if (!empty($label)) {
        ...
        $this->settings['extra_settings'] = get_option('wurdey_branding_extra_settings');
    }
    ...
    {
        $dell_all = array('wurdey_branding_disable_change',
            'wurdey_branding_child_hide',
            'wurdey_branding_show_support',
            'wurdey_branding_support_email',
            'wurdey_branding_support_message',
            'wurdey_branding_remove_restore',
            'wurdey_branding_remove_setting',
            'wurdey_branding_remove_wp_tools',
            'wurdey_branding_remove_wp_setting',
            'wurdey_branding_remove_permalink',
            //'wurdey_branding_plugin_header', // don't remove header
            'wurdey_branding_button_contact_label',
            'wurdey_branding_send_email_message',
            'wurdey_branding_message_return_sender',
            'wurdey_branding_submit_button_title',
            'wurdey_branding_extra_settings',
            'wurdey_branding_ext_enabled',
            );
    ...
    public function update_branding()
    {
        ...
        WurdeyHelper::update_option('wurdey_branding_ext_enabled', "Y");
        ...
        WurdeyHelper::update_option('wurdey_branding_plugin_header', $header);
        WurdeyHelper::update_option('wurdey_branding_support_email', $settings['child_support_email']);
        WurdeyHelper::update_option('wurdey_branding_support_message', $settings['child_support_message']);
        WurdeyHelper::update_option('wurdey_branding_remove_restore', $settings['child_remove_restore']);
        WurdeyHelper::update_option('wurdey_branding_remove_setting', $settings['child_remove_setting']);
        WurdeyHelper::update_option('wurdey_branding_remove_wp_tools', $settings['child_remove_wp_tools']);
        WurdeyHelper::update_option('wurdey_branding_remove_wp_setting', $settings['child_remove_wp_setting']);
        WurdeyHelper::update_option('wurdey_branding_remove_permalink', $settings['child_remove_permalink']);
        WurdeyHelper::update_option('wurdey_branding_button_contact_label', $settings['child_button_contact_label']);
        WurdeyHelper::update_option('wurdey_branding_send_email_message', $settings['child_send_email_message']);
        WurdeyHelper::update_option('wurdey_branding_message_return_sender', $settings['child_message_return_sender']);
        WurdeyHelper::update_option('wurdey_branding_submit_button_title', $settings['child_submit_button_title']);
         if (isset($settings['child_disable_wp_branding']) && ($settings['child_disable_wp_branding'] === "Y" || $settings['child_disable_wp_branding'] === "N"))
             WurdeyHelper::update_option('wurdey_branding_disable_wp_branding', $settings['child_disable_wp_branding']);
        ...
        WurdeyHelper::update_option('wurdey_branding_extra_settings', $extra_setting);
        
        if ($settings['child_plugin_hide'])
        {
            WurdeyHelper::update_option('wurdey_branding_child_hide', 'T');
        }
        else
        {
            WurdeyHelper::update_option('wurdey_branding_child_hide', '');
        }

        if ($settings['child_show_support_button'] && !empty($settings['child_support_email']))
        {
            WurdeyHelper::update_option('wurdey_branding_show_support', 'T');
        }
        else
        {
            WurdeyHelper::update_option('wurdey_branding_show_support', '');
        }

        if ($settings['child_disable_change'])
        {
            WurdeyHelper::update_option('wurdey_branding_disable_change', 'T');
        }
        else
        {
            WurdeyHelper::update_option('wurdey_branding_disable_change', '');
        }
    ...
    {   
        ...
        if (get_option('wurdey_branding_ext_enabled') !== "Y")
            return;
        ...
        if (!is_array($extra_setting)) 
            $extra_setting = array();       
        if (get_option('wurdey_branding_show_support') == 'T')
        {          
        ...
        if(get_option('wurdey_branding_disable_wp_branding') !== "Y") {
    ...
    {
        $email = get_option('wurdey_branding_support_email');
        $content = nl2br(stripslashes($_POST['wurdey_branding_contact_message_content']));
        if (!empty($_POST['wurdey_branding_contact_message_content']) && !empty($email))
        {
            global $current_user;            
            $mail = '<p>Support Email from: <a href="' . site_url() . '">' . site_url() . '</a></p>';
            $mail .= '<p>Sent from WordPress page: ' . (!empty($_POST['wurdey_branding_send_from_page']) ? '<a href="' . $_POST['wurdey_branding_send_from_page'] . '">' . $_POST['wurdey_branding_send_from_page'] . '</a></p>' : "");
            $mail .= '<p>Client Email: ' . $current_user->user_email . ' </p>';
            $mail .= '<p>Support Text:</p>';            
            $mail .= '<p>' . $content . '</p>';
            if (wp_mail($email, 'Wurdey - Support Contact', $mail, array('From: "' . $current_user->user_email . '" <' . $current_user->user_email . '>', 'content-type: text/html'))) ;
                return true;
        }
        return false;
    }
    ...
    <?php 
        if (isset($_POST['submit'])) {                  
            $from_page = $_POST['wurdey_branding_send_from_page'];
            $back_link = get_option('wurdey_branding_message_return_sender');
           ...
           if ($this->send_support_mail()) {
                $send_email_message = get_option("wurdey_branding_send_email_message");
           ...
           ?><div class="wurdey_info-box-yellow"><?php echo $send_email_message . "&nbsp;&nbsp" . $back_link; ?></div><?php
        } else {    
            $from_page = ""; 
            ...
            $support_message = get_option('wurdey_branding_support_message');
                    ...
                    <div style="width: 99%;">        
                        ...
                        <div style="height: auto; margin-bottom: 10px; text-align: left">                                                          
                            ...
                            <div style="max-width: 650px;">
                                ...
                                wp_editor( "", 'wurdey_branding_contact_message_content', array(
                                                'textarea_name' => 'wurdey_branding_contact_message_content',
                                                'textarea_rows' => 10,                                    
                                                'teeny' => true,
                                                'wpautop' => true,
                                                'media_buttons' => false,
                        ...
                        <br />
                        <?php
                            $button_title = get_option("wurdey_branding_submit_button_title");
                            $button_title = !empty($button_title) ? $button_title : __("Submit");
                        ?>
                        <input id="wurdey-branding-contact-support-submit" type="submit" name="submit" value="<?php echo $button_title; ?>"
                               class="button-primary button" style="float: left"/>        
                    </div>    
                    <input type="hidden"  name="wurdey_branding_send_from_page" value="<?php echo $from_page;?>" />
            </form>
    <?php } 
    }
    ...
    public function add_support_button_in_top_admin_bar($wp_admin_bar)
    {
        ...
        $args = array(
            ...
            'href' => $href,
            'meta' => array('class' => 'wurdey_branding_support_top_bar_button', 'title' => $this->settings['contact_support_label'])
        );
    ...
    public static function is_branding() {
        ...
        if (get_option('wurdey_branding_child_hide') == 'T')
            return true;
        // branding
        $header = get_option('wurdey_branding_plugin_header');
        ...
        if (stripos($_SERVER['REQUEST_URI'], 'update-core.php') !== false && self::is_branding())
        {
           ...
           <script>
                jQuery(document).ready(function(){
                    jQuery('input[type="checkbox"][value="wurdey-child/wurdey-child.php"]').closest('tr').remove();
                });        
            </script>
           <?php
        }
    ...
    {
        if (get_option('wurdey_branding_disable_change') == 'T')
        {
